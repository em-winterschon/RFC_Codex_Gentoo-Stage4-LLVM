...
assert_file_contains "${MANIFEST}" 'build_mode: controlled-archive-preload'
assert_file_contains "${MANIFEST}" 'localhost/rfc1918/ntfy:v2.14.0'
assert_file_contains "${MANIFEST}" 'archive_path: /var/lib/container-services/preload/ntfy-v2.14.0-amd64.oci-archive'
assert_file_contains "${MANIFEST}" 'sha256_file: /var/lib/container-services/preload/ntfy-v2.14.0-amd64.oci-archive.sha256'
