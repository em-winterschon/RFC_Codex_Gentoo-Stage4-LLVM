...
assert_file_contains "${routeros_spine_plan}" "routeros-state-snapshot.yml"
assert_file_contains "${routeros_spine_plan}" "collect-mikrotik-routeros-state.py"
...
assert_file_contains "${roadmap}" "PNR-021"
assert_file_contains "${roadmap}" "PNR-022"
