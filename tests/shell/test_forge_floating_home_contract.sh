...
assert_file_contains "${apply_playbook}" "vers=4.1"
...
assert_file_contains "${docs}" "Forge Workers FreeIPA + QNAP Floating Homes"
assert_file_contains "${docs}" "QNAP NFSv4.1"
...
assert_file_contains "${admin_host_vars}" "vers=4.1"
