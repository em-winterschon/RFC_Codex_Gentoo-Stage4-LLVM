...
assert_file_contains "${REDIS_ROLE}/defaults/main.yml" 'dev-db/redis -jemalloc'
assert_file_contains "${REDIS_ROLE}/tasks/main.yml" 'Write Redis cache package USE override'
