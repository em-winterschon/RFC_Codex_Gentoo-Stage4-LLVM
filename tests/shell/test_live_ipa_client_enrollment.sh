...
assert_file_not_contains "${host_vars}" 'profile-definitions/aaa-domain-client.yml'
...
assert_file_not_contains "${host_vars}" 'net-fs/samba'
...
assert_file_contains "${netboot_manifest}" 'profile-definitions/metal-workstation-basic-xorg.yml'
assert_file_not_contains "${netboot_manifest}" 'profile-definitions/aaa-domain-client.yml'
assert_file_contains "${netboot_manifest}" 'profile-definitions/secure-firstboot-enrollment.yml'
assert_file_contains "${netboot_manifest}" 'profile-package-lists/stage5-domain-client-freeipa-minimal.packages'
assert_file_not_contains "${netboot_manifest}" 'profile-package-lists/stage5-domain-client.packages'
assert_file_contains "${netboot_manifest}" 'profile-package-lists/stage5-secure-firstboot-enrollment.packages'
assert_file_not_contains "${netboot_manifest}" 'net-fs/samba'
