...
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PATHB_FEATURES="${PATHB_FEATURES:-buildpkg -binpkg-request-signature -network-sandbox}"'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PATHB_EMERGE_DEFAULT_OPTS="${PATHB_EMERGE_DEFAULT_OPTS:---buildpkg=y'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PKGDIR="${PATHB_GUEST_BINPKG_DIR}"'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'DISTDIR="${PATHB_GUEST_DISTFILES_DIR}"'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PATHB_ENABLE_HOST_CACHE_BINDS'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PATHB_HOST_BINPKG_DIR'
assert_file_contains "${ANSIBLE_ROOT}/scripts/build-path-b-netboot-artifacts.sh" 'PATHB_HOST_DISTFILES_DIR'
