...
assert_file_contains "${inventory}" "netboot_bootfile_url: http://172.16.99.108:8080/k10-ipxe.efi"
assert_file_contains "${inventory}" "netboot_firmware_policy: uefi-http-efi-only"
