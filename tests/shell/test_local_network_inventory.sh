...
assert_file_contains "${inventory}" "ansible_host: 172.16.99.88"
assert_file_contains "${inventory}" "parent_proxmox_vmid: 1088"
assert_file_contains "${inventory}" "stage5_profile: vm-netboot-publisher"
assert_file_contains "${inventory}" "routeros_serial_console_host: admin_sun99_forge_099070"
assert_file_contains "${inventory}" "sw_mgmt_mkcrs354:"
assert_file_contains "${inventory}" "routeros_serial_console: /dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AB0MRY3W-if00-port0"
assert_file_contains "${inventory}" "routeros_serial_console_current_tty: /dev/ttyUSB1"
assert_file_contains "${inventory}" "sw_spine_crs309_rfc99:"
assert_file_contains "${inventory}" "routeros_serial_console: /dev/serial/by-id/usb-FTDI_FT232R_USB_UART_A9888PID-if00-port0"
assert_file_contains "${inventory}" "routeros_serial_console_current_tty: /dev/ttyUSB0"
assert_file_contains "${inventory}" "routeros_state_snapshot_enabled: true"
assert_file_contains "${inventory}" "routeros_state_snapshot_transport: serial"
assert_file_contains "${inventory}" "rtr_mgmt_ccr2004:"
assert_file_contains "${inventory}" "gw_rfc99_mkccr2004_16g:"
assert_file_contains "${inventory}" "routeros_serial_console: /dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AB0MRY3X-if00-port0"
assert_file_contains "${inventory}" "routeros_serial_console_current_tty: /dev/ttyUSB4"
...
assert_file_contains "${inventory}" "netboot_next_server: 172.16.99.88"
...
assert_file_contains "${inventory}" "agx_rfc99_bunnydev_099034:"
assert_file_contains "${inventory}" "ansible_host: 172.16.99.34"
assert_file_contains "${inventory}" "local_network_role: inference-jetson-agx-thor"
assert_file_contains "${inventory}" "fqdn: agx-rfc99-bunnydev.rfc1918.host"
assert_file_contains "${inventory}" "inference_service_container_engine: docker"
assert_file_contains "${inventory}" "inference_service_allow_docker_exception: true"
assert_file_contains "${inventory}" "inference_service_accelerator: nvidia"
assert_file_contains "${inventory}" "ollama_servers:"
assert_file_contains "${inventory}" "open_webui_servers:"
assert_file_contains "${inventory}" "vllm_servers:"
assert_file_contains "${inventory}" "sglang_servers:"
assert_file_contains "${inventory}" "inference_service_thor_backend_policy: ollama-open-webui-first"
