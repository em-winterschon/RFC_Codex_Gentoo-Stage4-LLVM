...
assert_file_contains "${PLAYBOOK}" 'slurm_pilot_munge_service_name: munged'
...
assert_file_contains "${ANSIBLE_ROOT}/roles/services/templates/conf.d.j2" 'openrc_action_cgroup_v2_system_slice'
assert_file_contains "${ANSIBLE_ROOT}/roles/services/templates/conf.d.j2" 'openrc_action_cgroup_v2_controllers'
assert_file_contains "${ANSIBLE_ROOT}/roles/services/templates/init.d.j2" '/sys/fs/cgroup/system.slice'
assert_file_contains "${ANSIBLE_ROOT}/roles/services/templates/init.d.j2" 'cgroup.subtree_control'
