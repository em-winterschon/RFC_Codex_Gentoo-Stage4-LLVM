...
assert_file_contains "${SCRIPT}" 'INSTALL_MODE="${INSTALL_MODE:-cmdline}"'
assert_file_contains "${SCRIPT}" 'inst.${INSTALL_MODE}'
assert_file_contains "${SCRIPT}" 'INSTALL_IP_DNS_ARGS'
assert_file_contains "${SCRIPT}" '${INSTALL_NET_DEVICE}:none:${INSTALL_IP_DNS_ARGS}'
