...
assert_file_contains "${REPO_ROOT}/docs/BIGNETWORK-FMT2-SMOKETEST.md" "ab4af90f44"
assert_file_contains "${REPO_ROOT}/docs/BIGNETWORK-FMT2-SMOKETEST.md" "intentional segmentation boundary"
assert_file_contains "${ANSIBLE_ROOT}/inventories/local-network/group_vars/all/bignetwork.yml" "607daa3a01933028"
assert_file_contains "${ANSIBLE_ROOT}/inventories/local-network/group_vars/all/bignetwork.yml" "ab4af90f44"
