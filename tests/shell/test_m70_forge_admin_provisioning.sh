...
assert_contains "${ANSIBLE_ROOT}/inventories/local-network/group_vars/netboot_publishers.yml" "ifname=eth0:00:07:32:78:65:c6"
assert_contains "${ANSIBLE_ROOT}/inventories/local-network/group_vars/netboot_publishers.yml" "ip=172.16.99.70::172.16.99.1:255.255.255.0:admin-sun99-forge-099070:eth0:none"
