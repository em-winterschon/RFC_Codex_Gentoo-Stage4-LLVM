...
- Interfaces updated: 9
- MAC address objects created: 1
- IPAM rows created: 1
- IPAM rows updated: 19
- Device primary IPv4 pointers updated: 10
- Skipped writes: 0
- Errors: 0
...
- `172.16.99.22/24` -> `sbsoc-accel-int64-m70n2.rfc1918.host`
...
- Existing M70 canary DNS retained: `sbsoc-accel-int64-m70n2.rfc1918.host` A -> `172.16.99.22`; `m70n2.rfc1918.host` CNAME -> canonical.
- Added M70 canary convenience alias: `m70-canary.rfc1918.host` CNAME -> `sbsoc-accel-int64-m70n2.rfc1918.host`.

Final Hetzner validation:

- NetBox IPAM plan: 47 records, 0 skipped, 47 unchanged, 0 errors.
- Inventory/CNAME plan: 47 records, 12 CNAME records, 47 unchanged, 0 errors.
- Deletes: 0.
...
NetBox now has primary IPv4 set for 26 of 40 DCIM devices. The remaining 14 are intentionally unresolved or represented elsewhere:
...
- Planned/offline or source intentionally lacks a management IP: `ctbsd_rfc99_jailerprime_099099`, `gw_rfc99_mkccr2004_16g`, `qnap_archive_ts435xeu`, `tty-console-sfo200-ein-2011`, `ups_sun99_cyberpower_cp1500`, `vpn_rfc99_fmt2_openvpn_bridge`.
