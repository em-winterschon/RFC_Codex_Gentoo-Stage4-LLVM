...
| `AAA-005` | pending | Enroll APC PDUs, APC ATS, and UPS management cards into central RADIUS auth | `AAA-002`, `OBS-004`, power-device inventory | Scope includes APC AP7901/AP7902 PDUs, AP4450 ATS, AP9631/AP9641 UPS cards, and any compatible CyberPower/Eaton management modules. Preserve local break-glass accounts, test one low-risk device first, and document vendor-specific RADIUS attributes before bulk rollout. |
