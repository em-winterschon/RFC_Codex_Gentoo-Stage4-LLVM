...
| `WS-006` | active | Validate GMKtek K10 bare-metal Stage5 install before X12AGAIN | `WS-004`, K10 EFI handoff validation | K10 is on CSS326 `ge16`; iPXE NIC slot `04:00:00`, MAC `84:47:09:5F:21:64`, static lease `172.16.99.156`. DHCP option 67 is scoped to `http://172.16.99.108:8080/k10-ipxe.efi`; next removal condition is confirmed EFI handoff and iPXE asset fetch. Do not treat `172.16.99.160` as K10 until the duplicate/unknown host state is resolved. |
