...
| `WS-006` | active | Validate GMKtek K10 bare-metal Stage5 install before X12AGAIN | `WS-004`, K10 iPXE lease confirmation | K10 is on CSS326 `ge16`; iPXE NIC slot `04:00:00`, MAC `84:47:09:5F:21:64`. DHCP requests and replies were observed on 2026-05-07, but no lease IP or iPXE asset fetch is confirmed yet. Do not treat `172.16.99.160` as K10 until the duplicate/unknown host state is resolved. |
