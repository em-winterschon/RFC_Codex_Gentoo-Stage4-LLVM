...
| `PNR-017` | active | Rebuild CRS309 as RouterOS 10GbE spine aggregation switch | `PNR-012` | Plan added at `docs/superpowers/plans/2026-05-04-crs309-spine-aggregation.md`; port conflict normalized by assigning CRS354 LACP to CRS309 `sfp-sfpplus2/3`, Hasslehoff CCR2004-1G-2XS-PCIe DACs to `sfp-sfpplus4/5`, CSS326 to `sfp-sfpplus8`, and CCR2004 gateway uplink to `sfp-sfpplus1`. |
