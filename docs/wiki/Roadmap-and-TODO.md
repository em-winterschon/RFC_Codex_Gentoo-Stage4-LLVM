...
| `PNR-020` | pending | Convert RouterOS spine/distribution changes into idempotent Ansible roles | `PNR-017`, `PNR-018` | Encode CRS309 upgrade/package cleanup, CRS309/CRS354 LACP, disabled CRS354 stale OPNsense state, and post-change validation gates. |
