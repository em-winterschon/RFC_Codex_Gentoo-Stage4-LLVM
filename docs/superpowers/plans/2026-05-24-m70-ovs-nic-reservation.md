...
cabled to CCR2004 `ge3..ge6`, link at 1G/full, have no host management IPs,
and suppress IPv6 link-local addresses through `/etc/sysctl.d/91-m70-reserved-x553.conf`.
