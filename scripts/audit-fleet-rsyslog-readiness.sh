...
PLAYBOOK="${ANSIBLE_ROOT}/playbooks/fleet-rsyslog-readiness-audit.yml"
...
usage() {
  cat <<'USAGE'
Usage: audit-fleet-rsyslog-readiness.sh [--inventory PATH] [--limit PATTERN]

Runs the read-only fleet rsyslog readiness audit.
USAGE
}
